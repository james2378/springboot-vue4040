<template>
	<el-main class="bg">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','headmaster') || $check_field('add','headmaster') || $check_field('set','headmaster')" :xs="24" :sm="12" :lg="8">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','class_size') || $check_field('add','class_size') || $check_field('set','class_size')" :xs="24" :sm="12" :lg="8">

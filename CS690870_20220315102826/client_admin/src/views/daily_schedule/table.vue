<template>
	<el-main class="bg">
			...
			<el-row>
				...
				<el-col :xs="24" :sm="24" :lg="8">
					<el-form-item label="记录日期">
						<el-input v-model="query.record_date"></el-input>
					</el-form-item>
				</el-col>
				...
				<el-col :xs="24" :sm="10" :lg="8">
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/daily_schedule/table','add') || $check_action('/daily_schedule/view','add')" class="el-button el-button--default el-button--primary" to="./view?">添加
						</router-link>
						<el-button v-if="user_group == '管理员' || $check_action('/daily_schedule/table','del') || $check_action('/daily_schedule/view','del')" class="" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="schedule" label="时间安排"
				v-if="user_group == '管理员' || $check_field('get','schedule')" min-width="200">
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/daily_schedule/table','set') || $check_action('/daily_schedule/view','set') || $check_action('/daily_schedule/view','get') || $check_action('//table','add') || $check_action('//view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/daily_schedule/table','set') || $check_action('/daily_schedule/view','set') || $check_action('/daily_schedule/view','get')"
	...
	export default {
		...
		data() {
			return {
				...
				showModal: false,
				// 获取数据地址
				url_get_list: "~/api/daily_schedule/get_list?like=0",
				url_del: "~/api/daily_schedule/del?",

<template>
	<el-main class="bg">
			...
			<el-row>
				...
				<el-col :xs="24" :sm="10" :lg="8">
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/punch_in_every_day/table','add') || $check_action('/punch_in_every_day/view','add')" class="el-button el-button--default el-button--primary" to="./view?">添加
						</router-link>
						<el-button v-if="user_group == '管理员' || $check_action('/punch_in_every_day/table','del') || $check_action('/punch_in_every_day/view','del')" class="" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="today_temperature" label="今日体温"
				v-if="user_group == '管理员' || $check_field('get','today_temperature')" min-width="200">
			</el-table-column>
			<el-table-column prop="physical_state" label="身体状态"
				v-if="user_group == '管理员' || $check_field('get','physical_state')" min-width="200">
			</el-table-column>
			<el-table-column prop="punch_in_address" label="打卡地址"
				v-if="user_group == '管理员' || $check_field('get','punch_in_address')" min-width="200">
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/punch_in_every_day/table','set') || $check_action('/punch_in_every_day/view','set') || $check_action('/punch_in_every_day/view','get') || $check_action('//table','add') || $check_action('//view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/punch_in_every_day/table','set') || $check_action('/punch_in_every_day/view','set') || $check_action('/punch_in_every_day/view','get')"
	...
	export default {
		...
		data() {
			return {
				...
				showModal: false,
				// 获取数据地址
				url_get_list: "~/api/punch_in_every_day/get_list?like=0",
				url_del: "~/api/punch_in_every_day/del?",
